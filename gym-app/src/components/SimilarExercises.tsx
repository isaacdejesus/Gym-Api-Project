...
const SimilarExercises = ({targetMuscleExercises, equipmentExercises}: {targetMuscleExercises: exerciseState[] , equipmentExercises: exerciseState[]}) => {
    return (
        <Box sx={{ mt: { lg: '100px', xs: '0' } }}>
            <Typography variant="h3" mb={3} mt= {5}> Exercises targeting the same muscle</Typography>
            ...
            <Typography variant="h3" mb={3} mt={5}> Exercises that use the same equipment</Typography>
            <Stack direction='row' sx={{ p: '2', position: 'relative' }}>
